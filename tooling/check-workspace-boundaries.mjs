...
export const EXPECTED_WORKSPACE_DEPENDENCIES = Object.freeze({
  ...
  "@opendelegate/computer-use-mcp": Object.freeze([]),
  ...
  "@opendelegate/device-channel": Object.freeze([
    "@opendelegate/device-identity",
    "@opendelegate/protocol",
    "@opendelegate/worker-runtime",
  ]),
  ...
  "@opendelegate/knowledge-mcp": Object.freeze([]),
  ...
  "@opendelegate/platform-services": Object.freeze(["@opendelegate/release-integrity"]),
  ...
  "@opendelegate/service-host": Object.freeze([
    "@opendelegate/computer-use-os",
    "@opendelegate/main",
    "@opendelegate/platform-services",
    "@opendelegate/secrets",
    "@opendelegate/session-helper-ipc",
    "@opendelegate/session-helper-runtime",
    "@opendelegate/worker",
  ]),
  "@opendelegate/session-helper-ipc": Object.freeze([]),
  "@opendelegate/session-helper-runtime": Object.freeze([
    "@opendelegate/computer-use-os",
    "@opendelegate/secrets",
    "@opendelegate/session-helper-ipc",
  ]),
  ...
  "@opendelegate/worker": Object.freeze([
    "@opendelegate/agent-adapters",
