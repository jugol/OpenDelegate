...
OS-secure handoff, then hand enrollment to `.agents/skills/opendelegate-join/SKILL.md`. Do not read,
paste, attach, or summarize the file in Configuration Chat, Discord, logs, or an Agent prompt. If it
