...
export const spanishMessages = {
  ...
  budget: {
    ...
    hardIdleDetail:
      "{metrics} alcanzó la detención por inactividad. El propietario puede enviar un mensaje nuevo, por ejemplo, «Continuar», para reiniciar la ventana de inactividad; la inactividad por sí sola no requiere ampliar el presupuesto de la tarea.",
  ...
  join: {
    ...
    agentAssistedDetail:
      "Abre Codex, Claude o Hermes en el dispositivo nuevo. Al generar el archivo abajo también aparece un texto listo para usar; entrega ese texto y la ruta local del archivo descargado —nunca su contenido— a ese Agent.",
    agentPromptLabel: "Texto para Codex, Claude o Hermes en el dispositivo nuevo",
    agentPrompt:
    ...
    stepOne:
      "Abre Codex, Claude o Hermes en el dispositivo nuevo y pídele que prepare OpenDelegate Worker.",
    stepTwo:
